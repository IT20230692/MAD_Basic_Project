package com.example.mad_basic_operations.Database;
...
public class DBHandler extends SQLiteOpenHelper {
    ...
    public List readAllInfo(){
        ...
        while(cursor.moveToNext()) {
            long user = cursor.getLong(cursor.getColumnIndexOrThrow(UserProfile.Users.COLUMN_1));
            usernames.add(user);
        }
        cursor.close();
        return usernames;
    ...
    public List readAllInfo(String username){
        ...
        while(cursor.moveToNext()) {
            long user = cursor.getLong(cursor.getColumnIndexOrThrow(UserProfile.Users.COLUMN_1));
            long dob = cursor.getLong(cursor.getColumnIndexOrThrow(UserProfile.Users.COLUMN_2));
            long pass = cursor.getLong(cursor.getColumnIndexOrThrow(UserProfile.Users.COLUMN_3));
            long gender = cursor.getLong(cursor.getColumnIndexOrThrow(UserProfile.Users.COLUMN_4));
            userInfo.add(user);//0
            userInfo.add(dob);//1
            userInfo.add(pass);//2
